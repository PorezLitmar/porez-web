...
const CustomerOrderItemEditPage = () => {
            ...
            <div className="breadcrumbs text-sm w-full">
                <ul>
                    ...
                    <li><NavLink to={
                        query.get('mode') === 'copy' ?
                            {
                                pathname: '/customer/orders/' + id + '/edit-item' + (itemId !== undefined ? '/' + itemId : ''),
                                search: '?mode=copy'
                            }
                            :
                            '/customer/orders/' + id + '/edit-item' + (itemId !== undefined ? '/' + itemId : '')
                    }
                        ...
                        <BoardProvider>
                            <EdgeProvider>
                                <OrderItemEditor
                                    ...
                                    afterSubmitNavigationHandler={() => navigate('/customer/orders/' + id + '/edit')}
                                />
                            </EdgeProvider>
                        </BoardProvider>
                    </CategoryProvider>
...
export default CustomerOrderItemEditPage;
